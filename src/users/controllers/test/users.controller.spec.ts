...
describe('UsersController', () => {
  ...
  describe('when user is created', () => {
    const userCreateMockResult: Users = {
      uuid: '1',
      firstName: 'First Name',
      lastName: 'Last Name',
      isActive: true,
    };
    const userCreateMockDto: UserRequestDto = {
      firstName: 'First Name',
      lastName: 'Last Name',
      createdAt: new Date(),
    };
    ...
    it('should return created user', async () => {
      ...
      expect(result.id).toEqual(userCreateMockResult.uuid);
  ...
  describe('when user is updated', () => {
    ...
    const userMockResult: Users = {
      uuid: userMockId,
      firstName: 'First Name',
      lastName: 'Last Name',
      isActive: true,
    };
    const userUpdateMockDto: UserRequestDto = {
      firstName: 'New First Name',
      lastName: 'New Last Name',
      createdAt: new Date(),
    };
    const userUpdatedMockResult: Users = {
      ...userMockResult,
      firstName: userUpdateMockDto.firstName,
      lastName: userUpdateMockDto.lastName,
      isActive: false,
    };
    ...
    it('should return updated user', async () => {
      ...
      expect(result?.id).toEqual(userUpdatedMockResult.uuid);
  ...
  describe('Find One By Id', () => {
    describe('when user is found', () => {
      ...
      it('should return one found user', async () => {
        ...
        expect(result?.id).toEqual(userMockResult.uuid);
    ...
    describe('when user is not found', () => {
      ...
      it('should throw an exception message', async () => {
        await expect(controller.findOne(userMockId)).rejects.toThrow(
          `User ${userMockId} not found`,
        );
      });

      it('should throw 404 not found exception', async () => {
        await expect(controller.findOne(userMockId)).rejects.toBeInstanceOf(
          NotFoundException,
        );
      });
    });
